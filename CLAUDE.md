...
- **Tests:** 839 unit (vitest, src/lib/\*.test.ts) + 57 package + integration, lint clean
...
| 2.6.5   | **Phase B Modularisierung**: main.ts in 8 lib/handlers/_ zerlegt (cloud-creds, cloud-retry, diagnostics, group-fanout, group-state-helpers, snapshot-handler-glue, state-change-router, wizard). device-manager.ts in 4 lib/device-manager/_ zerlegt (cache, cloud-merge, lookups, mapping). Free-fn-Pattern mit Adapter-Context-Interfaces; Class-Felder public für strukturelles Typing. main.ts 2008→1159 LOC (-42%), device-manager.ts 1660→1268 (-24%). 768/768 Tests grün throughout.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
